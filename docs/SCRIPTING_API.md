...
`identity`、`team`、`position`、`health`、`movement`、`combat`、`weapons`、`orders`、`pathing`、`transport`、`build`、`production`、`actions`、`abilities`、`damage`、`selection`、`map`、`resources`、`projectiles`、`environment`、`catalog`、`all`。
...
| 值 | 含义 |
|---|---|
| `player` | 当前变化未匹配任何脚本指令，且发生于己方可控单位 |
| `script` | 当前变化匹配框架记录的脚本指令 |
| `game` | 初始状态、自然状态或非己方指令状态 |
...
| `relation/relation_name` | team | 与本地队伍关系：`0/self`、`1/enemy`、`2/ally`。|
