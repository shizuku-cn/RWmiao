...
public final class RWMiaoFreeBuildAction extends s {
    public static RWMiaoFreeBuildAction INST = new RWMiaoFreeBuildAction();

    public RWMiaoFreeBuildAction() {
        super("c__cut_rwmiao_free_build");
    }

    public String a() { return "Toggle free build placement"; }
    public int b(ce unit, boolean preview) { return -1; }
    public String b() { return RWMiaoBridge.freeBuildTitle(); }
    ...
    public boolean c(ce unit, boolean alternate) {
        RWMiaoBridge.toggleFreeBuild(unit);
        return true;
    }
